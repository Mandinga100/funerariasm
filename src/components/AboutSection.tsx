          ...
          <div ref={contentRef}>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="group flex items-center gap-2 bg-gold hover:bg-gold-dark text-accent-foreground px-6 py-3 rounded-full text-sm tracking-wide-brand uppercase transition-brand hover:shadow-[0_8px_30px_-6px_hsl(var(--gold)/0.4)]"
              >
              ...
              <a
                ...
                className="group flex items-center gap-2 border border-foreground/20 hover:border-gold text-foreground hover:text-gold px-6 py-3 rounded-full text-sm tracking-wide-brand uppercase transition-brand"
              >
