  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 container text-center text-primary-foreground">
        ...
        <div ref={gridRef} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
          <a
          ...
          >
            <Phone className="w-8 h-8 text-gold transition-transform duration-300 group-hover:-rotate-12 group-hover:scale-110" />
          ...
          <a
            ...
            className="group flex flex-col items-center gap-3 bg-primary-foreground/10 hover:bg-gold/20 border border-primary-foreground/10 hover:border-gold/30 rounded-lg p-6 transition-brand hover:shadow-[0_12px_40px_-12px_hsl(var(--gold)/0.2)]"
          >
            <MessageCircle className="w-8 h-8 text-gold transition-transform duration-300 group-hover:scale-110" />
          ...
          <Link
            ...
            className="group flex flex-col items-center gap-3 bg-primary-foreground/10 hover:bg-gold/20 border border-primary-foreground/10 hover:border-gold/30 rounded-lg p-6 transition-brand hover:shadow-[0_12px_40px_-12px_hsl(var(--gold)/0.2)]"
          >
            <FileText className="w-8 h-8 text-gold transition-transform duration-300 group-hover:scale-110" />
