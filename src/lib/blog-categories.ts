...
const CATEGORY_IMAGES: Record<string, string> = {
  novedades: "/assets/images/brand/logo.webp",
  duelo: "/assets/images/otros/consuelo.webp",
  "contencion-emocional": "/assets/images/otros/empatia.webp",
  "salud-mental": "/assets/images/otros/compasion.webp",
  "apoyo-familiar": "/assets/images/otros/respeto.webp",
  guias: "/assets/images/brand/logo.webp",
  prevision: "/assets/images/otros/calidad.webp",
  servicios: "/assets/images/servicios/funerales-gala.webp",
};
...
export const getCategoryImage = (category: string | null): string => {
  ...
  return CATEGORY_IMAGES[normalized] || "/assets/images/brand/logo.webp";
};
